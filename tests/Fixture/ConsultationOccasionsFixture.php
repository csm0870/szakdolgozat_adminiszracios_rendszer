...
/**
 * ConsultationOccasionsFixture
 *
 */
class ConsultationOccasionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'FK_consultation_occasions_cosultations' => ['type' => 'foreign', 'columns' => ['consultation_id'], 'references' => ['consultations', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
