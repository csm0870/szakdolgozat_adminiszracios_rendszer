...
class StudentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'final_exam_subject_internal_consultant_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            ...
            'FK_students_final_exam_internal_consultants_idx' => ['type' => 'index', 'columns' => ['final_exam_subject_internal_consultant_id'], 'length' => []],
        ],
        '_constraints' => [
            ...
            'FK_students_final_exam_internal_consultants' => ['type' => 'foreign', 'columns' => ['final_exam_subject_internal_consultant_id'], 'references' => ['internal_consultants', 'id'], 'update' => 'cascade', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-02-19 21:15:06',
                'modified' => '2019-02-19 21:15:06',
                'course_id' => 1,
                'course_level_id' => 1,
                'course_type_id' => 1,
                'user_id' => 1,
                'final_exam_subject_internal_consultant_id' => 1
            ],
        ];
        parent::init();
    }
