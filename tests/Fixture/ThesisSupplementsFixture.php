...
/**
 * ThesisSupplementsFixture
 *
 */
class ThesisSupplementsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_thesis_supplements_thesis_topics_idx' => ['type' => 'index', 'columns' => ['thesis_topic_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_thesis_supplements_thesis_topics' => ['type' => 'foreign', 'columns' => ['thesis_topic_id'], 'references' => ['thesis_topics', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
