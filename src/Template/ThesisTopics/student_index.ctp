<div class="container student-thesisTopics-index">
    <div class="row">
                    ...
                    <?php 
                        if(!empty($can_fill_in_topic) && $can_fill_in_topic === true){
                            if(!empty($can_add_topic) && $can_add_topic === true)
                                echo $this->Html->link(__('Új téma hozzáadása'), ['controller' => 'ThesisTopics', 'action' => 'studentAdd'], ['class' => 'btn btn-outline-secondary btn-block']);
                        }else{ ?>
