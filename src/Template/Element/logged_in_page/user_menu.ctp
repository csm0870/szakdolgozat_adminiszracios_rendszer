    ...
    <div class="col-12 navbar-container">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item" id="topic_manager_dashboard_menu_item">
            ...
            <li class="nav-item" id="topic_manager_set_topic_filling_in_period_menu_item">
            ...
            <li class="nav-item" id="topic_manager_set_encryption_requlation_menu_item">
