<div class="container">
    <div class="row">
        ...
        <div class="col-12">
            ...
            <?= $this->Form->control('internal_consultant_id', ['class' => 'form-control', 'disabled' => ($thesisTopic->has('offered_topic') || $thesisTopic->thesis_topic_status_id == \Cake\Core\Configure::read('ThesisTopicStatuses.ProposalForAmendmentOfThesisTopicAddedByHeadOfDepartment')),
