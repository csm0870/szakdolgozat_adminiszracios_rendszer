<div class="container">
    <div class="row">
        <div class="col-12 text-center page-title">
            ...
            <h4><?= __('Belső konzulens hozzáadása') ?></h4>
        </div>
        <div class="col-12">
            <?= $this->Flash->render() ?>
        </div>
        <div class="col-12">
            <?php
                ...
                echo $this->Form->create($internalConsultant, ['id' => 'internalConsultantAddForm']);
...
<script>
    $(function(){
        ...
        */
        $('#internalConsultantAddForm .submitBtn').on('click', function(e){
            e.preventDefault();

            //Formvalidáció manuális meghívása
            if($('#internalConsultantAddForm')[0].reportValidity() === false) return;
            ...
            $('#confirmationModal .modalBtn.saveBtn').on('click', function(e){
                ...
                $('#internalConsultantAddForm').trigger('submit');
            });
        });
    });
</script>