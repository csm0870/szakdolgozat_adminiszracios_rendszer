    ...
    <div class="row">
        ...
        <div class="col-12">
            <?php
                ...
                echo $this->Form->control('internal_consultant_id', ['class' => 'form-control', 'options' => $internalConsultants, 'label' => ['text' => __('Belső konzulens')]]);
                ...
                echo $this->Form->control('is_thesis', ['class' => 'form-control', 'type' => 'select', 'value' => 0, 'empty' => false, 'options' => [__('Diplomamunka'), __('Szakdolgozat')] ,'label' => ['text' => __('Típus')]]);
...
<script>
    $(function(){
        ...
        */
        $('#offeredTopicAddForm .submitBtn').on('click', function(e){
            e.preventDefault();

            //Formvalidáció manuális meghívása
            if($('#offeredTopicAddForm')[0].reportValidity() === false) return;
            ...
            $('#confirmationModal .modalBtn.saveBtn').on('click', function(e){
                ...
                $('#offeredTopicAddForm').trigger('submit');
            });
        });
