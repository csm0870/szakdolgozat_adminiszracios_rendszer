<div class="form-modal admin-departments-add">
    <?= $this->Form->create($department, ['id' => 'departmentAddForm']) ?>
    <div class="form-header text-center">
        <?= __('Tanszék hozzáadása') ?>
    </div>
    <div class="form-body">
            <table>
                <tr>
    ...
    <?= $this->Form->end() ?>
    <div class="overlay overlay-department-add" style="display:none">
...
<script>
    $(function(){
         ...
         */
        $('#departmentAddForm .submitBtn').on('click', function(e){
            e.preventDefault();

            //Formvalidáció manuális meghívása
            if($('#departmentAddForm')[0].reportValidity() === false) return;
            ...
            $('#confirmationModal .modalBtn.saveBtn').on('click', function(e){
                ...
                $('#departmentAddForm').trigger('submit');
            });
        });
        ...
        $('#departmentAddForm').ajaxForm({
            ...
            beforeSubmit: function(arr, $form, options) {
                $('.overlay-department-add').show();
            },
            success: function (response, textStatus, jqXHR, $form) {
                    if(response.saved == false){
                        $('.overlay-department-add').hide();
