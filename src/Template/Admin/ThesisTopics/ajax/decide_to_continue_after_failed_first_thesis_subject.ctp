<div class="form-modal admin-decideToContinueAfterFailedFirstThesisSubject">
    ...
    <script>
        $(function(){
            ...
            $('#decideToContinueAfterFailedFirstThesisSubjectForm .submitBtn').on('click', function(e){
                ...
                $('#confirmationModal .msg').html('<?= __('Első diplomakurzus sikertelen, döntés a folytatásról.') . '<br/><br/>' .__('Művelet végrehajtója') . ': ' . __('tanszékvezető') ?>');
