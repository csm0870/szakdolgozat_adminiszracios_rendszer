<div class="container thesisManager-checkReview">
    <div class="row">
        ...
        <div class="col-12">
            <fieldset class="border-1-grey p-3 text-center">
                ...
                <?= $this->Html->link(__('Feltöltött bírálati lap letöltése'), ['action' => 'getReviewDoc', $thesisTopic->id], ['class' => 'btn btn-secondary border-radius-45px mb-2', 'target' => '__blank']) ?>
            </fieldset>
        </div>
    </div>
</div>
